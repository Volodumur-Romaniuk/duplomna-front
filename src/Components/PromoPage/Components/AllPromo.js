        ...
        <div className="allpromo">
            ...
            <div className="container">
                <div className="element-promo">
                    <div className="all-promo-info">
                        <p className="title1 font-oregano"> Wine colection</p>
                    ...
                    <div className="about-book-image">
                        <img src="https://alethemes.com/alesushi/wp-content/uploads/sites/105/2021/12/pb12.jpg" alt="" className="img1" />
                        <img src="https://alethemes.com/alesushi/wp-content/uploads/sites/105/2021/12/pb11.jpg" alt="" className="img2" />
                ...
                <div className="element-promo">
                    ...
                    <div className="about-book-image">
                        <img src="https://alethemes.com/alesushi/wp-content/uploads/sites/105/2021/12/pb32.jpg" alt="" className="img1" />
                        <img src="https://alethemes.com/alesushi/wp-content/uploads/sites/105/2021/12/pb31.jpg" alt="" className="img2" />
                        <img src="https://alethemes.com/alesushi/wp-content/themes/alesushi/assets/svg/longdecor.svg" alt="" className="icon-left" />
                    </div>
                </div>
            </div>
